...
public class YatzyInitializer {
  ...
  public record Dice (int d1, int d2, int d3, int d4, int d5) {
    ...
    public YatzyInitializer(Dice diceInput)
    {
        ...
        yatzyCases.put("TWOS", new Tows());
        yatzyCases.put("THREES", new Threes());
        yatzyCases.put("FOURS", new Fours());
        yatzyCases.put("FIVES", new Fives());
        yatzyCases.put("SIXES", new Sixes());
